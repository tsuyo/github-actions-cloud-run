...
COPY ./target/github-actions-cloud-run-jfrog-*.jar /github-actions-cloud-run-jfrog.jar

# Run the web service on container startup.
CMD ["java", "-Djava.security.egd=file:/dev/./urandom", "-jar", "/github-actions-cloud-run-jfrog.jar"]
